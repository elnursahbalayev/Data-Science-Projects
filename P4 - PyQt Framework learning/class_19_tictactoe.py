...
class UI(QMainWindow):
    ...
    def clicker(self, b):
        ...
        #check if won
        # print(self.button1.text(), self.button4.text(), self.button7.text())
        self.checkWin()
